...
int correction_left_stop = 3;// Correction for the motors
int correction_right_stop = 3;
int correction_left_drive = 0;// Correction for the motors when driving
