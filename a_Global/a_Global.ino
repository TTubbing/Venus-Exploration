...
//basic movement
const int timeturn = 2000; // Total time needed to turn 360 degree
int correction_left = 0;// Correction for the motors
int correction_right = 77;
...
int update_interval = 500; // interval between measurements
int distance_to_mountain; // distance to the mountain
